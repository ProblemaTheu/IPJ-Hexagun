...
public class HexMap : MonoBehaviour
{
    ...
    void CriarMapa(){
        ...
        int vorticeX = rNd.Next(1,larMapa);
        int vorticeZ = rNd.Next(1,altMapa);

        GameObject TempGO1 = Instantiate(Vortice);

        if(vorticeZ%2 == 0){

                    TempGO1.transform.position = new Vector3(vorticeX *tileXOffset, 0.055f, vorticeZ *tileZOffset);


                }
                else{

                    TempGO1.transform.position = new Vector3(vorticeX * tileXOffset + tileXOffset/2, 0.055f, vorticeZ * tileZOffset);
                }
    ...
    int vorticeX1 = rNd.Next(0, larMapa);
    int vorticeZ1 = rNd.Next(1, altMapa);

        GameObject TempGO2 = Instantiate(Vortice1);

        if(vorticeZ1%2 == 0){

                    TempGO2.transform.position = new Vector3(vorticeX1 *tileXOffset, 0.055f, -1*(vorticeZ1 *tileZOffset));


                }
                else{

                    TempGO2.transform.position = new Vector3(vorticeX1 * tileXOffset + tileXOffset/2, 0.055f, -1*(vorticeZ1 * tileZOffset));
                }
